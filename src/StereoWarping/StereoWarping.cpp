...
//    glCullFace(GL_FRONT);
    ...
    GLuint programTFID = LoadShadersTransformFeedback("..\\src\\shaders\\TFVertex.glsl", "", "..\\src\\shaders\\TFGeometry.glsl");
    GLuint programDrawQuadID = LoadShadersTransformFeedback( "..\\src\\shaders\\AdapGridVertex.glsl", "", "..\\src\\shaders\\AdapGridGeometry.glsl");
	GLuint programRenderingID = LoadShaders( "..\\src\\shaders\\TransformVertexShader.glsl" ,"..\\src\\shaders\\SimpleFragmentShader.glsl");
    GLuint programID= LoadShaders("..\\src\\shaders\\DisparityVertexShader.glsl", "..\\src\\shaders\\DisparityFragmentShader.glsl");
    GLuint MaxPyrProgramID = LoadShaders("..\\src\\shaders\\MaxPyrVertex.glsl", "..\\src\\shaders\\MaxPyrFragmentShader.glsl");
    GLuint WarpingProgramID = LoadShaders("..\\src\\shaders\\WarpingVertex.glsl", "..\\src\\shaders\\WarpingFragment.glsl");
    GLuint OGProgramID = LoadShaders("..\\src\\shaders\\OGvertex.glsl", "..\\src\\shaders\\OGfragment.glsl");
    GLuint MinPyrProgramID = LoadShaders("..\\src\\shaders\\MinPyrVertex.glsl", "..\\src\\shaders\\MinPyrFragment.glsl");
    GLuint PlainProgramID = LoadShaders("..\\src\\shaders\\PlainVertex.glsl", "..\\src\\shaders\\PlainFragment.glsl");
    ...
    unsigned char *data0 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\floor1.jpg", &width0, &height0, &nrChannels0, 0);
    unsigned char *data1 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\veshalka.jpg", &width1, &height1, &nrChannels1, 0);
    unsigned char *data2 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\doors1.jpg", &width2, &height2, &nrChannels2, 0);
    unsigned char *data3 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\Alyscamps_Arles_dos.JPG", &width3, &height3, &nrChannels3, 0);
    unsigned char *data4 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\belye.jpg", &width4, &height4, &nrChannels4, 0);
    unsigned char *data5 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\bad1.jpg", &width5, &height5, &nrChannels5, 0);
    unsigned char *data6 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\rest.jpg", &width6, &height6, &nrChannels6, 0);
    unsigned char *data7 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\wall_staff.jpg", &width7, &height7, &nrChannels7, 0);
    unsigned char *data8 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\table.jpg", &width8, &height8, &nrChannels8, 0);
    unsigned char *data9 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\chair1.jpg", &width9, &height9, &nrChannels9, 0);
    unsigned char *data10 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\wall1.jpg", &width10, &height10, &nrChannels10, 0);
    unsigned char *data11 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\win_right.jpg", &width11, &height11, &nrChannels11, 0);
    unsigned char *data12 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\win_left.jpg", &width12, &height12, &nrChannels12, 0);
    unsigned char *data13 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\glass_right.png", &width13, &height13, &nrChannels13, 0);
    unsigned char *data14 = stbi_load("..\\src\\StereoWarping\\Enter a title.zip\\glass_left.png", &width14, &height14, &nrChannels14, 0);
    ...
    vector<GLuint> texture_code_list;
	//bool res = loadOBJ("./Enter a title.zip/Enter a title.obj", vertices, uvs, normals);
    loadOBJWithMTL("..\\src\\StereoWarping\\Enter a title.zip\\Enter a title.obj", vertices, uvs, normals, texture_code_list);
    ...
    loadOBJ("..\\src\\StereoWarping\\ATAT\\AtAt.obj", vertices_ATAT, uvs_ATAT, normals_ATAT);
...
//    GLuint adaptexID = glGetUniformLocation(programID, "adaptivegridTexture");
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width1, height1, 0, GL_RGB, GL_UNSIGNED_BYTE, data1);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID1, 1);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width2, height2, 0, GL_RGB, GL_UNSIGNED_BYTE, data2);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID2, 2);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width3, height3, 0, GL_RGB, GL_UNSIGNED_BYTE, data3);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID3, 3);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width4, height4, 0, GL_RGB, GL_UNSIGNED_BYTE, data4);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID4, 4);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width5, height5, 0, GL_RGB, GL_UNSIGNED_BYTE, data5);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID5, 5);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width6, height6, 0, GL_RGB, GL_UNSIGNED_BYTE, data6);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID6, 6);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width7, height7, 0, GL_RGB, GL_UNSIGNED_BYTE, data7);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID7, 7);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width8, height8, 0, GL_RGB, GL_UNSIGNED_BYTE, data8);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID8, 8);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width9, height9, 0, GL_RGB, GL_UNSIGNED_BYTE, data9);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID9, 9);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width10, height10, 0, GL_RGB, GL_UNSIGNED_BYTE, data10);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID10, 10);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width11, height11, 0, GL_RGB, GL_UNSIGNED_BYTE, data11);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID11, 11);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width12, height12, 0, GL_RGB, GL_UNSIGNED_BYTE, data12);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID12, 12);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width13, height13, 0, GL_RGB, GL_UNSIGNED_BYTE, data13);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID13, 13);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width14, height14, 0, GL_RGB, GL_UNSIGNED_BYTE, data14);
    glGenerateMipmap(GL_TEXTURE_2D);
//    glUniform1i(TextureID14, 14);
	...
	do{
		...
		glActiveTexture(GL_TEXTURE1);
		glBindTexture(GL_TEXTURE_2D, Texture1);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width1, height1, 0, GL_RGB, GL_UNSIGNED_BYTE, data1);
		glUniform1i(TextureID1, 1);

		glActiveTexture(GL_TEXTURE2);
		glBindTexture(GL_TEXTURE_2D, Texture2);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width2, height2, 0, GL_RGB, GL_UNSIGNED_BYTE, data2);
		glUniform1i(TextureID2, 2);


		glActiveTexture(GL_TEXTURE3);
		glBindTexture(GL_TEXTURE_2D, Texture3);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width3, height3, 0, GL_RGB, GL_UNSIGNED_BYTE, data3);
		glUniform1i(TextureID3, 3);

		// Bind our texture in Texture Unit 0
		glActiveTexture(GL_TEXTURE4);
		glBindTexture(GL_TEXTURE_2D, Texture4);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width4, height4, 0, GL_RGB, GL_UNSIGNED_BYTE, data4);
		glUniform1i(TextureID4, 4);

		// Bind our texture in Texture Unit 0
		glActiveTexture(GL_TEXTURE5);
		glBindTexture(GL_TEXTURE_2D, Texture5);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width5, height5, 0, GL_RGB, GL_UNSIGNED_BYTE, data5);
		glUniform1i(TextureID5, 5);

		glActiveTexture(GL_TEXTURE6);
		glBindTexture(GL_TEXTURE_2D, Texture6);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width6, height6, 0, GL_RGB, GL_UNSIGNED_BYTE, data6);
		glUniform1i(TextureID6, 6);

		glActiveTexture(GL_TEXTURE7);
		glBindTexture(GL_TEXTURE_2D, Texture7);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width7, height7, 0, GL_RGB, GL_UNSIGNED_BYTE, data7);
		glUniform1i(TextureID7, 7);

		glActiveTexture(GL_TEXTURE8);
		glBindTexture(GL_TEXTURE_2D, Texture8);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width8, height8, 0, GL_RGB, GL_UNSIGNED_BYTE, data8);
		glUniform1i(TextureID8, 8);

		glActiveTexture(GL_TEXTURE9);
		glBindTexture(GL_TEXTURE_2D, Texture9);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width9, height9, 0, GL_RGB, GL_UNSIGNED_BYTE, data9);
		glUniform1i(TextureID9, 9);

		glActiveTexture(GL_TEXTURE10);
		glBindTexture(GL_TEXTURE_2D, Texture10);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width10, height10, 0, GL_RGB, GL_UNSIGNED_BYTE, data10);
		glUniform1i(TextureID10, 10);

		glActiveTexture(GL_TEXTURE11);
		glBindTexture(GL_TEXTURE_2D, Texture11);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width11, height11, 0, GL_RGB, GL_UNSIGNED_BYTE, data11);
		glUniform1i(TextureID11, 11);

		glActiveTexture(GL_TEXTURE12);
		glBindTexture(GL_TEXTURE_2D, Texture12);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width12, height12, 0, GL_RGB, GL_UNSIGNED_BYTE, data12);
		glUniform1i(TextureID12, 12);

		glActiveTexture(GL_TEXTURE13);
		glBindTexture(GL_TEXTURE_2D, Texture13);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width13, height13, 0, GL_RGB, GL_UNSIGNED_BYTE, data13);
		glUniform1i(TextureID13, 13);

		glActiveTexture(GL_TEXTURE14);
		glBindTexture(GL_TEXTURE_2D, Texture14);
		glTexSubImage2D(GL_TEXTURE_2D, 0, GL_RGB8, width14, height14, 0, GL_RGB, GL_UNSIGNED_BYTE, data14);
		glUniform1i(TextureID14, 14);
